...
import cn.edu.seu.herald.session.jee.JeeSessionConstants;
...
public class DemoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Session currentSession = (Session) request.getAttribute(
                JeeSessionConstants.SESSION_ATTRIB_NAME);
        ...
        // update the session
        currentSession.setAttribute("foo", "bar");
        out.close();
    }
